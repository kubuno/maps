...
pub const CATEGORIES: &[PoiCategory] = &[
    ...
    PoiCategory { id: "attraction",  icon: "📸",  filters: &[("tourism", "attraction"), ("tourism", "viewpoint"), ("tourism", "theme_park"), ("tourism", "zoo"), ("tourism", "aquarium")] },
    ...
    PoiCategory { id: "transit",     icon: "🚏",  filters: &[("highway", "bus_stop"), ("railway", "station"), ("railway", "tram_stop"), ("railway", "subway_entrance"), ("amenity", "bus_station"), ("public_transport", "station")] },
